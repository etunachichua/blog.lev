                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-default toggle panelMove panelRefresh">
                                ...
                                <div class="panel-heading">
                                    <h4 class="panel-title">გვერდის დამატება</h4>
                                </div>
                                <div class="panel-body pb0">
                                    
                                    <form id="add" class="form-horizontal group-border hover-stripped" role="form" action="<?= base_url() ?>admin/pages/adddata/">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-sm-10">
                                                <input id="name_geo" name="name_geo" class=" form-control" type="text">
                                            </div>
                                        </div>
                                        <div class="form-group">
                                            <label for="desc_geo" class="control-label col-sm-2">მოკლე აღწერა</label>
                                            <div class="col-sm-10">
                                                <textarea id="desc_geo" cols="100" rows="2" name="desc_geo" maxlength="160" ></textarea>
                                            </div>
                                        </div>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="col-lg-10 col-md-9">
                                                <textarea cols="50" rows="16" id="demo" name="text_geo"></textarea>
                                            </div>
                                        </div>
                                        <div class="form-group">
