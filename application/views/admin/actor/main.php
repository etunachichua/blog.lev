                            ...
                            <div class="panel panel-default toggle panelMove panelRefresh">
                                ...
                                <div class="panel-body">
                                    <table id="tabletools" class="table table-striped table-bordered" cellspacing="0" width="100%">
                                        ...
                                        <tbody>
                                            <?php foreach ($actors as $actor) { ?>
                                                <tr data-tid="<?= $actor->ID ?>">
                                                    ...
                                                    <td><?= $actor->img ?></td>
                                                    <td>
                                                        <a href="<?= base_url() ?>admin/actors/edit/<?= $actor->ID ?>" class="sepV_a ext_disabled" title="Edit"><i class="icomoon-icon-pencil-3"></i></a>
                                                        <a href="#" class="sepV_a" title="View"><i class="icomoon-icon-eye-7"></i></a>
                                                        <a  class="delete" id="delete<?= $actor->ID ?>" data-id="<?= $actor->ID ?>" data-link="<?= base_url() ?>admin/actors/delete/" title="Delete"><i class="icomoon-icon-remove-3"></i></a>
                                     ...
                                     <a href="<?=base_url()?>admin/actors/add" class="btn addBtn pull-right">ახალი მსახიობის დამატება</a>
                                </div>
                            </div>
                            <!-- End .panel -->
                        </div>
