                                        ...
                                        <tbody>
                                            <?php foreach ($bases as $base) { ?>
                                                <tr data-tid="<?= $base->id ?>">
                                                    ...
                                                    <td><?= $base->email ?></td>
                                                    <td><?=$base->user_type?></td>
                                                    <td>
                                                        <a href="<?= base_url() ?>admin/admin/edit/<?= $base->id ?>" class="sepV_a ext_disabled" title="Edit"><i class="icomoon-icon-pencil-3"></i></a>
                                                        <a href="#" class="sepV_a" title="View"><i class="icomoon-icon-eye-7"></i></a>
                                                        <a  class="delete" id="delete<?= $base->id ?>" data-id="<?= $base->id ?>" data-link="<?= base_url() ?>admin/admin/delete/" title="Delete"><i class="icomoon-icon-remove-3"></i></a>
