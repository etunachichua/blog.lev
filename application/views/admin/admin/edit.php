                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="panel panel-default toggle panelMove panelRefresh">
                                ...
                                <div class="panel-body pb0">
                                    ...
                                    <form id="edit" class="form-horizontal group-border hover-stripped" role="form" action="<?= base_url() ?>admin/admin/editdata/">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="input-group input-icon">
                                                            ...
                                                            <input type="text" placeholder="მეტსახელი" name="username" class="form-control" value="<?= $base->username ?>">
                                                        </div>
                                                    </div>
                                                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                        <div class="input-group input-icon">
                                                            <span class="input-group-addon"><i class="icomoon-icon-mail-send s16"></i> </span>
                                                            <input type="text" placeholder="ელ.ფოსტა" name="email" class="form-control" value="<?= $base->email ?>">
